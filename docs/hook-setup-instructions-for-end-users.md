...
**Windows：**
```cmd
copy "D:\Projects\easycode\EasyCode\.easycode\hooks\hook-template.bat" "%USERPROFILE%\.easycode-user\hooks\test-hook-logger.bat"
```

**macOS/Linux：**
```bash
cp "/Users/yourname/Projects/easycode/EasyCode/.easycode/hooks/hook-template.sh" "$HOME/.easycode-user/hooks/test-hook-logger.sh"
