...
### EasyCode 自定义 (`provider: "easycode"`)

适用于自定义 EasyCode 兼容端点（使用 OpenAI 格式）。
...
2. **模型调用**
   ...
   - `packages/core/src/core/EasyCodeServerAdapter.ts` - 统一调用入口
...
- ✨ 新增自定义模型配置功能
- 🎨 自定义模型 UI 视觉区分
- 🔧 支持 OpenAI/Claude/EasyCode 三种格式
- 📝 完整的文档和示例
...
- GitHub Issues: https://github.com/OrionStarAI/EasyCodeCode/issues
