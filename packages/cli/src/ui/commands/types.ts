...
export interface OpenDialogActionReturn {
  type: 'dialog';
  dialog: 'help' | 'auth' | 'login' | 'theme' | 'editor' | 'privacy' | 'model' | 'customModelWizard' | 'settings-menu' | 'init-choice' | 'plugin-install' | 'debate-wizard' | 'debate-resume' | 'goal-wizard' | 'effort-wizard';
