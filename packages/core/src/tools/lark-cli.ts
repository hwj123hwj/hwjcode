  ...
  constructor(private readonly config: Config) {
    super(
      ...
      [
        ...
        '',
        '## Docs (Documents)',
        '- Create doc from markdown file: command="docs +create" args=["--api-version", "v2", "--content", "@<relative-path>", "--doc-format", "markdown"]',
        '  NOTE: Use --content (NOT --markdown). The @ prefix reads a local file (must be relative path). Use --doc-format markdown when content is markdown.',
        '- Create doc from inline text: command="docs +create" args=["--api-version", "v2", "--content", "<text>", "--doc-format", "markdown"]',
        '- Fetch doc content: command="docs +fetch" args=["--api-version", "v2", "--document-id", "<id>"]',
        '- Update doc: command="docs +update" args=["--api-version", "v2", "--document-id", "<id>", "--content", "<text>", "--doc-format", "markdown"]',
