...
export type WebViewToExtensionMessage =
  ...
  // 🎯 项目设置相关
  | { type: 'project_settings_update'; payload: { yoloMode: boolean; preferredModel?: string; thinkingConfig?: any; healthyUse?: boolean; modelOverrides?: { compression?: string; codeExpert?: string; verification?: string } } }
...
export type ExtensionToWebViewMessage =
  ...
  // 🎯 项目设置相关
  | { type: 'project_settings_response'; payload: { yoloMode: boolean; preferredModel?: string; healthyUse?: boolean; thinkingConfig?: any; modelOverrides?: { compression?: string; codeExpert?: string; verification?: string } } }
  // 🎯 服务初始化状态
