...
export class MultiSessionCommunicationService {
  ...
  // 🎯 项目设置更新监听器
  onProjectSettingsUpdate(handler: (data: { yoloMode: boolean; preferredModel?: string; healthyUse?: boolean; thinkingConfig?: any; modelOverrides?: { compression?: string; codeExpert?: string; verification?: string } }) => void): vscode.Disposable {
  ...
  // 🎯 发送项目设置响应
  async sendProjectSettingsResponse(settings: { yoloMode: boolean; preferredModel?: string; healthyUse?: boolean; thinkingConfig?: any; modelOverrides?: { compression?: string; codeExpert?: string; verification?: string } }) {
    await this.sendMessage({
