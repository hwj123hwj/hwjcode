...
export const enUS: Translations = {
  ...
  settings: {
    ...
    general: {
      ...
      overrideAutoDefault: 'Default (auto)',
      overrideInherit: 'Inherit session model',
      overrideCompressionLabel: 'Compression model',
      overrideCompressionDesc: 'Model used for context compression. Unset = built-in default.',
      overrideCodeExpertLabel: 'Code Expert sub-agent model',
      overrideCodeExpertDesc: 'Model for the code-analysis sub-agent. Unset = inherit the session model.',
      overrideVerificationLabel: 'Verification sub-agent model',
      overrideVerificationDesc: 'Model for the verification sub-agent. Unset = inherit the session model.',
    },
    memory: {
      title: 'Memory Files',
