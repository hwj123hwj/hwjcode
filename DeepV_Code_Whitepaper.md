...
使用全局安装 Easy Code CLI，获得 `dvcode` 命令：
...
*   **介绍**: 在项目目录中初始化 Easy Code 的配置文件 `DEEPV.md`。
*   **使用**: `/init`
...
*   **获取 Easy Code**: 访问我们的官方网站 [[DvCode](https://dvcode.deepvlab.ai/zh/install)] 下载并安装 Easy Code CLI 和 VS Code 扩展。
